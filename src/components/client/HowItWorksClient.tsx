...
// ✅ CLIENT COMPONENT - Localized How It Works section
// Uses translations with Framer Motion scroll animations
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stepKeys.map((key) => {
            ...
            return (
              <div key={key} className="group relative bg-base-300/20 border border-base-300 p-8 hover:border-base-500 transition-colors duration-300">
                {/* Decorative Corner */}
                ...
                <h3 className="font-mono text-xl text-base-100 mb-4 uppercase tracking-wider">
                  {t(`steps.${key}.title`)}
                </h3>
